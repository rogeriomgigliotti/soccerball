<%@ Page Title="Copa do mundo 2022 - Jogos" Language="C#" MasterPageFile="~/Base/Site.master"
    AutoEventWireup="true" CodeBehind="Game.aspx.cs" Inherits="WebSite.Pages.Game" %>
                            ...
                            <asp:DataGrid runat="server" ID="dgJogo" AutoGenerateColumns="false" CellPadding="3"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemStyle HorizontalAlign="Right" Width="127px" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
